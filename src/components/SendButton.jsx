    ...
    <StyledWrapper>
      <button className="button">
        ...
        <div className="state state--default">
          ...
          <p>
  <span data-i="0">S</span>
  <span data-i="1">e</span>
  <span data-i="2">n</span>
  <span data-i="3">d</span>
  <span data-i="4">M</span>
  <span data-i="5">e</span>
  <span data-i="6">s</span>
  <span data-i="7">s</span>
  <span data-i="8">a</span>
  <span data-i="9">g</span>
  <span data-i="10">e</span>
</p>
        ...
        <div className="state state--sent">
          ...
          <p>
  <span data-i="5">S</span>
  <span data-i="6">e</span>
  <span data-i="7">n</span>
  <span data-i="8">t</span>
</p>
...
const StyledWrapper = styled.div`
  ...
  .button:focus .state--sent span {
    opacity: 0;
   animation: slideDown 0.8s ease forwards calc(attr(data-i) * 0.03s);
